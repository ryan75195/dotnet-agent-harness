...
public class CodeStructureTests
{
    ...
    {
        var assemblies = new[] { TestHelpers.CoreAssembly, TestHelpers.FunctionsAssembly };
    ...
    public void Should_place_test_fixtures_in_namespace_matching_source_assembly()
    {
        ...
        {
            ["SampleDurable.Core"] = ".Core",
            ["SampleDurable.Functions"] = ".Functions"
        };

        var sourceAssemblies = new[] { TestHelpers.CoreAssembly, TestHelpers.FunctionsAssembly };
    ...
    public void Should_declare_at_most_one_public_type_per_file()
    {
        ...
        var srcDirs = new[]
        {
            Path.Combine(solutionRoot, "src", "SampleDurable.Core"),
            Path.Combine(solutionRoot, "src", "SampleDurable.Functions")
        };
